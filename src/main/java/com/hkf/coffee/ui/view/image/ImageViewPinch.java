 ...
 * @author clifford
 */
public class ImageViewPinch extends AppCompatImageView {
    ...
    public ImageViewPinch(Context context) {
        super(context);
        initView();
    }

    public ImageViewPinch(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public ImageViewPinch(Context context, AttributeSet attrs, int defStyle) {
    ...
    //点击，双击，长按，滑动等手势处理
    private GestureDetector mGestureDetector = new GestureDetector(ImageViewPinch.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            if (mOnLongClickListener != null) {
                mOnLongClickListener.onLongClick(ImageViewPinch.this);
            }
        }
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            if (mOnClickListener != null) {
                mOnClickListener.onClick(ImageViewPinch.this);
            }
            return true;
        }
    });
