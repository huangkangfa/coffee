...
import com.hkf.coffee.jars.nohttp.error.NotFoundFileError;
...
public class FileBinary implements Binary {
    ...
    /**
     * To monitor file upload ui_update_progress, more than {@link FileBinary} can use the same {@link OnUploadListener}.
     *
